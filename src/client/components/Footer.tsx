  ...
  const benefits = siteConfig.benefits ?? [
    {
      ...
      description:
        "Camisas produzidas conforme a necessidade do seu projeto ou evento.",
    },
    {
      title: "Atendimento para grupos",
      description:
        "Soluções para empresas, igrejas, equipes e ações promocionais.",
    },
    {
      title: "Qualidade no acabamento",
      description:
        "Peças desenvolvidas com conforto, durabilidade e atenção aos detalhes.",
    },
  ];
  ...
  return (
    <footer className="w-full overflow-hidden">
              ...
              return (
                <div key={item.title} className="flex flex-col items-center">
                  <div
                    ...
                    style={{
                      backgroundColor:
                        "color-mix(in srgb, var(--color-accent-light) 35%, white)",
      ...
      <div
        ...
        style={{
          backgroundColor:
            "color-mix(in srgb, var(--color-accent) 82%, black)",
          borderColor:
